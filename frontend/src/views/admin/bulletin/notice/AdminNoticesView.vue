...
<template>
  <div class="page-container">
    <div class="page-header">
      <h2>公告管理</h2>
      <router-link to="/admin/bulletin/notice/new">
        <el-button type="primary">新增公告</el-button>
      </router-link>
    </div>

    <div class="search-bar">
      <el-input v-model="params.title" placeholder="搜索公告标题" clearable style="width: 240px" @keyup.enter="handleCurrentChange(1)" />
      ...
      <el-table v-if="list.length" :data="list" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button type="primary" link size="small" @click="$router.push(`/admin/bulletin/notice/edit/${row.id}`)">编辑</el-button>

  ...
  setTimeout(() => {
    tableData.value = [
      ...
      },
      {
        ...
        experimentType: '加工实验',
        purpose: '学习数控车床操作',
        startTime: '2026-07-17 08:00:00',
        endTime: '2026-07-17 16:00:00',
        status: 2,
        auditRemark: '该时段实验室已安排其他课程',
      ...
      },
      {
        ...
        name: '数据结构实验',
        experimentType: '编程实验',
        purpose: '实现链表、栈、队列等数据结构',
        startTime: '2026-07-18 13:00:00',
        endTime: '2026-07-18 17:00:00',
        status: 0,
        auditRemark: '',
